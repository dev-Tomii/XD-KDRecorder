...
d = tk.StringVar(root)
d.set(0)
options_list = ["Elige un modo", "Escolta", "Control de Zonas", "Dominacion", "Ocupacion", "Estrella", "CLB", "TDM"]
...
option.grid(row=1, column=0, padx=5, pady=10, sticky='nsew')
